...
const COLOR_MUTED = '#323a45';
const COLOR_MUTED_MORE = '#1a1e27';
// const COLOR_ERROR = '#9c1011';
const COLOR_ERROR = '#aa1113';
const COLOR_WARNING = '#f0862c';
const COLOR_SUCCESS = '#53CA27';
const COLOR_EMPHASIS = '#5591af';
const COLOR_EMPHASIS_MORE = '#6ac4e5';


const LOGGER_STYLES = {
  _emphasis: chalk.bgHex(COLOR_MUTED).white,
  _emphasis_less: chalk.bgHex(COLOR_MUTED_MORE).hex(COLOR_EMPHASIS),
  muted: chalk.hex(COLOR_MUTED),
  [`_status_${LOG_LEVEL.info}`]: chalk.hex(COLOR_MUTED),
  [`_status_${LOG_LEVEL.success}`]: chalk.bold.hex(COLOR_SUCCESS),
  [`_status_${LOG_LEVEL.warning}`]: chalk.bgHex(COLOR_MUTED_MORE).hex(COLOR_WARNING),
  [`_status_${LOG_LEVEL.error}`]: chalk.bgHex(COLOR_ERROR).white,
  primary: chalk.bold.hex(COLOR_EMPHASIS_MORE),
  rc_logo: chalk.red,
